...
> **Where it sits.** Not a workflow skill — a utility you reach for at any time: at the **start** of work (what was done/decided here before?), to **redo** a past prompt, or to **review** the project's activity. It is the activity-history companion to the Docs Explorer (which shows the artifact graph); `/auditlog` shows the *timeline of actions and decisions* behind it.
