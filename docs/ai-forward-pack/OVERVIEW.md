...
├─ knowledge/   28 docs (+FOUNDATION manifest) — 21 reasoning + 7 vendored Agent-Knowledge-Pack foundation (BoK, Rules of the Road, Persona Catalog, LOA, Governance, Testing Strategy, C# Style)
├─ commands/    (the 18 skills, one SKILL.md each)
├─ templates/   (the 22 artifact templates)
