...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 322 public functions across 21 modules, 41% carrying a docstring.
---
...
| [`coord-core.py`](coord-core.md) | 59 | 36 | 24 | coord-core.py - agent coordination, Phase 1 walking skeleton. |
...
**Total** — 322 public functions across 21 modules, **132 documented (41%)**.
