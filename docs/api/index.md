...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 326 public functions across 21 modules, 42% carrying a docstring.
---
...
| [`audit-log.py`](audit-log.md) | 36 | 18 | 13 | audit-log.py — the AI-Forward Pack audit & change log bundle (audit-and-change-log.md). |
...
**Total** — 326 public functions across 21 modules, **136 documented (42%)**.
