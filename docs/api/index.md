...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 323 public functions across 21 modules, 41% carrying a docstring.
---
...
| [`coord-core.py`](coord-core.md) | 60 | 37 | 24 | coord-core.py - agent coordination, Phase 1 walking skeleton. |
...
**Total** — 323 public functions across 21 modules, **133 documented (41%)**.
