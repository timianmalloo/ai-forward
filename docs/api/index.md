...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 506 public functions across 37 modules, 48% carrying a docstring.
---
...
| [`coord-core.py`](coord-core.md) | 94 | 70 | 36 | coord-core.py - agent coordination, Phase 1 walking skeleton. |
...
**Total** — 506 public functions across 37 modules, **241 documented (48%)**.
