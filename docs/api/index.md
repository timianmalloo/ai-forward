...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 325 public functions across 21 modules, 42% carrying a docstring.
---
...
**Total** — 325 public functions across 21 modules, **135 documented (42%)**.
