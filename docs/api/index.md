...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 334 public functions across 21 modules, 43% carrying a docstring.
---
...
**Total** — 334 public functions across 21 modules, **144 documented (43%)**.
