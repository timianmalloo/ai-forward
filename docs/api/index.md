...
summary: >-
  Generated API reference for the pack's public surface — the deployed script bundle. 331 public functions across 21 modules, 43% carrying a docstring.
---
...
| [`session-profile.py`](session-profile.md) | 31 | 11 | 4 | session-profile.py — measure how agent sessions actually ran, across harnesses and models. |
...
**Total** — 331 public functions across 21 modules, **141 documented (43%)**.
