...
window.AUDIT_DATA = {
  "project": "ai-forward",
  "generated": "2026-09-21T00:02:24Z",
  "audit": [
    {
      "actor": null,
      "artifacts": [
    ...
    {
      "id": "al-01M30EHWFTCBRCC3TMVK1ZAJRV",
    ...
    {
      "id": "al-01M30FAZGE2DZBRT6VH6F5AX6H",
    ...
    {
      "id": "al-01M30FV3C00ECTAC9SGVYWP0XM",
    ...
    {
      "id": "al-01M30G7KTCSYH132EBY7F558AR",
    ...
    {
      "id": "al-01M30GDDCBZV4TDNGCESTZEFA0",
    ...
    {
      "id": "al-01M30H6NPMRRJ5KS0CE7W6NB25",
    ...
    {
      "id": "al-01M30HW4TSSSKCKKENY8S9KWRG",
    ...
    {
      "id": "al-01M30J02K76345M4ES7BP8A42N",
    ...
    {
      "id": "al-01M30J3RMQPHATZN93FJFM62SD",
    ...
    {
      "id": "al-01M30JKKQ472N4613NYHDFC7B1",
      ...
      "summary": "BLOCK: reproduced real CLI allow for HELD.TXT while samefile with owner-leased held.txt is true on current filesystem. Reproduced empty stdout exit1 for malformed valid-JSON lease row [] and unreadable ledger directory, so native deny is lost. Reproduced path shortening from Python splitlines U+2028: native apply_patch tool accepts full filename but recognizer checks free instead of full free-U2028-plus-suffix; exact leased name then falsely allowed. Reproducer /tmp/native-hook-independent-review.py. Native tests10pass1failure: hostile-checkout fixture lacks repo_identity import dependency and does not yet prove quoting. Core reuse and private host/cwd telemetry are proportionate; no patch content observed in decisions. Require filesystem-aware alias handling, complete hook exception projection, native line grammar and restored deployed fixture.",
      "kind": "skill",
    ...
    {
      "id": "al-01M30JP6RNV51Q1RVB9DN1BQ9T",
    ...
    {
      "id": "al-01M30K5ZZWPAARACRAZ00AASPC",
    ...
    {
      "id": "al-01M30KBCFMG3QQRAYQFSGANB9D",
    ...
    {
      "id": "al-01M30KJ6KMWBF9FA52TVT0T64N",
    ...
    {
      "id": "al-01M30KJT1P0B1VJBM7EABJ203J",
    ...
    {
      "id": "al-01M30KTQCPZAFSDXXWN6E0BDY0",
    ...
    {
      "id": "al-01M30MAQS9W0NBE5J85VWXYMF3",
