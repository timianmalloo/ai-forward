window.DREAM_DATA = {
  ...
  "proposals": [
    ...
    },
    {
      "kind": "Control upgrade",
      "group": "Control upgrade",
      "title": "PACK-O: 57/58 substantive turns (98%) recorded no goal-state (done_when)",
      ...
      "evidence": [
        {
          "eid": "al-0003",
          "note": "create a new skill in this project: \"ForensicReview\" which provides a de… - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0004",
          "note": "extendaibundle-forensicreview - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0005",
          "note": "Review graph and mindmap - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0006",
          "note": "design-docs-explorer - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0007",
          "note": "Use the implement skill to implement the docs explorer redesign. - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0008",
          "note": "implement-docs-explorer - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0009",
          "note": "implement-grounded-spatial-explorer - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0010",
          "note": "extendaibundle-model-orchestration - no done_when recorded (front matter skipped)"
        },
        {
          "eid": "al-0077",
    ...
    },
    {
      ...
      "evidence": [
        ...
        {
          "eid": "pack/scripts/coord-core.py#L855",
