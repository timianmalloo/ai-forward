...
| **Best next action** | P2 (encoding sweep: 21 subprocess decodes, stdio guards) and P3 (newline sweep, `.gitattributes` template) together — the Windows job is now the instrument that proves each sweep. |
