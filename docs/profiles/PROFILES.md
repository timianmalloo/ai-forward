...
*sp-0003, sp-0004 and sp-0005 are the **same twelve sessions** re-measured as each new detector landed — SP-19 (main-line dominance) in sp-0004, SP-20 (late addition on an unbounded turn) in sp-0005, SP-21 (model attribution) in sp-0006. The earlier rows are kept rather than deleted: a profile is a record of what the instrument could see on the day, and the arrival of a finding is itself part of the history. **Read sp-0006 for these sessions; the others are superseded.**
