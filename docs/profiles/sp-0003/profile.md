...
summary: >-
  Measured pass over 12 session(s) in theterrace (last 10 days); 36 finding(s), top: SP-01, SP-02, SP-03.
---
# Session profile sp-0003

*Generated 2026-09-06T22:11:11Z by `session-profile.py`. Every number is read from the harness's own store unless marked est. (chars/token = 3.54). A missing measurement reads `not recorded`, never a guess (IO8).*
...
| SP-13 | Nit | Verified | Hook overhead above 5% of wall clock | copilot:fd3ccb67 | hooks 2426s of 37633s wall (6%) |  |
| SP-17 | Nit | Verified | Reasoning visibility: the share of billed reasoning that came back as readable text | copilot:fd3ccb67 | 604,851 reasoning tokens billed on the main line; 97,167 chars of reasoning text on disk (~5% visible at 3.54 chars/token) | F-12 |
...
| openai | copilot | 19 | 27.2 | 16,308,918 | 60,473 | 28,688 | 1.9% | high | 100.0% | 4,188.2 | 36.4 | 452,425 | 1390 | 4.79 |
...
| 26 | are you getting off task again? | openai | 10 | 436,472 | 452,425 | 4,531,339 | 14,359 | 1,040.5 | 50.1 | 367 | 0 | 0 | no | no |
