...
summary: >-
  Measured pass over 12 session(s) in theterrace (last 10 days); 37 finding(s), top: SP-01, SP-02, SP-03.
---
# Session profile sp-0004

*Generated 2026-09-06T22:23:12Z by `session-profile.py`. Every number is read from the harness's own store unless marked est. (chars/token = 3.54). A missing measurement reads `not recorded`, never a guess (IO8).*
...
| SP-19 | Major | Verified | Main-line dominance: the turn's own loop, not its delegates, is where the cost is | copilot:fd3ccb67 | main line 727 requests / 91,734 AIU (91.5% of the session) vs delegates 703 / 8,497; 10.4x the cost per request | F-14 |
...
| SP-14 | Major | Verified | Model-family gap: one family carries 2x the cost or drift indicators of another on comparable turns | *:* | openai/copilot: 4.79 drift indicators per turn vs anthropic/copilot: 1.0; caveat: the turn mix differs (19 vs 10 turns); confirm on like-for-like tasks before tuning | F-10 |
...
| SP-13 | Nit | Verified | Hook overhead above 5% of wall clock | copilot:fd3ccb67 | hooks 2446s of 38385s wall (6%) |  |
| SP-17 | Nit | Verified | Reasoning visibility: the share of billed reasoning that came back as readable text | copilot:fd3ccb67 | 622,872 reasoning tokens billed on the main line; 97,623 chars of reasoning text on disk (~4% visible at 3.54 chars/token) | F-12 |
...
| anthropic+openai | copilot | 2 | 72.0 | 28,159,404 | 184,516 | 113,320 | 0.2% | high | 100.0% | 7,593.0 | 90.8 | 459,972 | 4372 | 10.0 |
| openai | copilot | 19 | 27.9 | 16,639,210 | 61,670 | 29,661 | 1.9% | high | 100.0% | 4,315.5 | 36.4 | 452,739 | 1430 | 4.79 |
...
started 2026-09-04T16:39:22Z · updated 2026-09-05T23:32:54Z · cwd `C:\projects\theterrace` · prefix ~116,798 est. tokens / 413,465 chars · compactions 4 · settings {'model': 'claude-opus-4.8', 'contextTier': 'long_context', 'effortLevel': 'high'}
...
| 26 | are you getting off task again? | openai | 24 | 436,472 | 484,425 | 10,806,887 | 37,104 | 3,459.3 | 62.0 | 1119 | 0 | 0 | no | no |
