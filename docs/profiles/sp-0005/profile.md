...
summary: >-
  Measured pass over 12 session(s) in theterrace (last 10 days); 38 finding(s), top: SP-01, SP-02, SP-03.
---
# Session profile sp-0005

*Generated 2026-09-06T22:56:36Z by `session-profile.py`. Every number is read from the harness's own store unless marked est. (chars/token = 3.54). A missing measurement reads `not recorded`, never a guess (IO8).*
...
| SP-19 | Major | Verified | Main-line dominance: the turn's own loop, not its delegates, is where the cost is | copilot:fd3ccb67 | main line 744 requests / 93,814 AIU (91.3% of the session) vs delegates 745 / 8,926; 10.5x the cost per request | F-14 |
...
| SP-14 | Major | Verified | Model-family gap: one family carries 2x the cost or drift indicators of another on comparable turns | *:* | anthropic+openai/copilot: 5.5 drift indicators per turn vs anthropic/copilot: 1.0; caveat: the turn mix differs (4 vs 10 turns); confirm on like-for-like tasks before tuning | F-10 |
...
| SP-13 | Nit | Verified | Hook overhead above 5% of wall clock | copilot:fd3ccb67 | hooks 2547s of 40432s wall (6%) |  |
| SP-17 | Nit | Verified | Reasoning visibility: the share of billed reasoning that came back as readable text | copilot:fd3ccb67 | 652,979 reasoning tokens billed on the main line; 98,663 chars of reasoning text on disk (~4% visible at 3.54 chars/token) | F-12 |
...
| anthropic+openai | copilot | 4 | 46.2 | 21,273,056 | 131,511 | 79,894 | 0.3% | high | 100.0% | 5,288.5 | 90.8 | 514,445 | 2977 | 5.5 |
...
| 30 | as an anchor for why i keep telling you to stay  | — | 0 | not recorded | not recorded | 0 | 0 | 0 | not recorded | — | 0 | 0 | no | no |
