...
summary: >-
  Measured pass over 12 session(s) in theterrace (last 10 days); 40 finding(s), top: SP-01, SP-02, SP-03.
---
# Session profile sp-0008

*Generated 2026-09-07T00:05:55Z by `session-profile.py`. Every number is read from the harness's own store unless marked est. (chars/token = 3.54). A missing measurement reads `not recorded`, never a guess (IO8).*
...
| SP-22 | Major | Verified | Mechanical work at reasoning prices: a closing turn billed as though it needed novelty | copilot:fd3ccb67 | t0: mechanical close at effort=high: 1,179 AIU over 31 main request(s); t2: mechanical close at effort=high: 896 AIU over 10 main request(s); t3: mechanical close at effort=high: 627 AIU over 10 main request(s) | F-17 |
| SP-20 | Major | Verified | Late addition on an unbounded turn: an `/also` that inherited no goal state or fanned out above no tier | copilot:fd3ccb67 | t9: no goal state to inherit, so the addition acquired no bound; t10: no goal state to inherit, so the addition acquired no bound; t32: no goal state to inherit, so the addition acquired no bound | F-15 |
| SP-21 | Major | Verified | Model attribution: the recorded setting is not the model that ran | copilot:fd3ccb67 | recorded setting 'claude-opus-4.8'; effective model 'gpt-6-astra' at 97.0% of main-line cost across 2 distinct model(s) | F-16 |
| SP-19 | Major | Verified | Main-line dominance: the turn's own loop, not its delegates, is where the cost is | copilot:fd3ccb67 | main line 787 requests / 102,230 AIU (91.6% of the session) vs delegates 840 / 9,414; 11.6x the cost per request | F-14 |
...
| SP-13 | Nit | Verified | Hook overhead above 5% of wall clock | copilot:fd3ccb67 | hooks 2741s of 44595s wall (6%) |  |
| SP-17 | Nit | Verified | Reasoning visibility: the share of billed reasoning that came back as readable text | copilot:fd3ccb67 | 718,512 reasoning tokens billed on the main line; 99,072 chars of reasoning text on disk (~4% visible at 3.54 chars/token) | F-12 |
...
| openai | copilot | 20 | 25.8 | 15,531,176 | 57,353 | 27,297 | 2.0% | high | 100.0% | 4,054.2 | 38.1 | 520,450 | 1334 | 4.55 |
...
started 2026-09-04T16:39:22Z · updated 2026-09-05T23:32:54Z · cwd `C:\projects\theterrace` · prefix ~116,798 est. tokens / 413,465 chars · compactions 4 · settings {'model': 'claude-opus-4.8', 'contextTier': 'long_context', 'effortLevel': 'high'} · EFFECTIVE model gpt-6-astra (97.0% of main-line cost, 2 distinct)
...
| 31 | this is ridiculous - what is taking so much time | openai | 2 | 641,856 | 645,469 | 1,281,658 | 3,409 | 296.1 | 49.9 | 110 | 0 | 0 | no | no |
| 32 | /also why do these "avoidable delays" and "tange | openai | 7 | 647,540 | 655,066 | 4,003,748 | 9,025 | 2,253.9 | 52.9 | 523 | 0 | 0 | no | no |
