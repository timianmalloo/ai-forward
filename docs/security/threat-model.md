...
- **Docs Explorer ← committed Markdown/frontmatter**: malformed or hostile content must
  ...
  and source-cited. Optional CDN/3D code is never required for the local core.
...
| [design-docs-explorer-grounding-spatial-navigation](design/docs-explorer-grounding-and-spatial-navigation.md) | Optional 3D experiment -> browser | **T/D** dependency is compromised or exhausts the renderer | mitigate | Not core; current API/license spike; lazy load; capability/size gate; disposal/fallback. | Block/fault candidate renderer and confirm equivalent core. |
