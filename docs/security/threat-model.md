...
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Malformed/oversized/duplicate/out-of-order control | Prevent with schema, size, exclusive immutable publication, sequence and exact identity checks; mutate every field in tests. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Concurrent enqueue/finish/decision | Serialize allocation/publication, one decision per request; concurrent-process test checks no lost writes or double approval. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Partial publication/crash after dispatch | Atomic files; consumed admission is never replayed; crash tests require indeterminate/blocked outcome. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Stale leader, manifest/profile drift, replaced root | Detect/fence before every prompt/retry/decision; existing drift tests extended. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Prompt or permission spoofing/tampering | Owner/epoch and compilation checks; native session correlation; exact offered allow_once only; forged IDs/options and altered pending requests rejected. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Repudiation | Immutable local controls plus body digests and public decision/dispatch events. Same-OS-user malicious rewriting remains outside boundary and is stated, not called authenticated. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Disclosure | Native details/prompts only private files, mode0600; sanitized events/errors; sentinel-secret tests. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Flood/hang/denial of service | Run time/byte/turn/control-count bounds; expiry/cancellation while waiting; no unbounded background children. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Escalation by unattended mode | Mode grants no permissions. Timeout/default deny. Persistent allow options rejected. Native trust and policy retained. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Retry after mutation/ambiguous response | Prevent automatic replay once prompt_started is observed; test EOF before vs after dispatch and dirty checkout between attempts. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Native live attach unavailable | Fail with capability-specific remedy; never simulate success with saved-session load or terminal typing. |
| [design-coordination-runtime-v2](design/coordination-runtime-v2.md) | Fixture missing/corrupt/wrong history | Pinned original Git object pack, isolated object store, unchanged parent/ancestry/content checks; fresh-clone and corrupt-fixture tests. |
