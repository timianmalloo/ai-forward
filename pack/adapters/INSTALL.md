...
bundle_version: '2026.08.16.1'
revision: 37
counts: { lenses: 23, skills: 21, knowledge_docs: 33, templates: 26, scripts: 15 }
...
| The 21 skills (`commands/*/SKILL.md`) | `.claude/skills/<name>/SKILL.md` | `.github/prompts/<name>.prompt.md` (wrapper that carries the same flow) |
